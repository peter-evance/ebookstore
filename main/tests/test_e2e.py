...
#     def test_book_page_switches_images_correctly(self): 
...
#                 book=book,image=ImageFile(f, name=fname),)
#             image.save()
#         self.selenium.get(
...
#         self.selenium.find_element_by_css_selector("div.image:nth-child(3) > img:nth-child(1)"
#                                                 ).click()
